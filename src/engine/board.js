...
export const SECTIONS = [
  ...
  [ // fortress — outer ring corridor with a sealed inner chamber
    '####.#####',
    '#........#',
    '#.######.#',
    '#.#....#.#',
  ...
  [ // bridge — two open chambers linked by a narrow central span
    '####.#####',
    '#.......##',
    '##.......#',
    '###.....##',
  ...
  [ // alcoves — wide corridor with dead-end pockets north and south
    '####.#####',
    '#....#...#',
    '#....#...#',
    '#........#',
  ...
  [ // pillars — open floor with a symmetric scattered-pillar grid
    '####.#####',
    '#........#',
    '#.#...#..#',
    '#........#',
  ...
  [ // dungeon — cell-block rooms branching off a cross-corridor hub
    '####.#####',
    '#.##.##.##',
    '#.#...#..#',
    '#.#...#..#',
  ...
  [ // labyrinth — winding corridors with pocketed dead ends
    '####.#####',
    '#....#...#',
    '###.###.##',
    '#........#',
