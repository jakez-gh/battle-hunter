...
const FLOOR_A = [
  'GGGGGGGGGGGGGGGG', 'GggGGGGGGGGGGGgG', 'GGGGGGGGdGGGGGGG', 'GGGGGGGGGGGGGGGG',
  'GGGdGGGGGGGGGGGG', 'GGGGGGGGGGGGgGGG', 'GGGGGGgGGGGGGGGG', 'GGGGGGGGGGGGGGGG',
  'GGGGGGGGGGdGGGGG', 'GgGGGGGGGGGGGGGG', 'GGGGGGGGGGGGGGGG', 'GGGGGdGGGGGGGgGG',
  'GGGGGGGGGGGGGGGG', 'GGgGGGGGGdGGGGGG', 'GGGGGGGGGGGGGGGG', 'dGGGGGGGGGGGGGGd',
];
const FLOOR_B = FLOOR_A.map((r) => r.replaceAll('d', 'g'));
const FLOOR_C = [...FLOOR_A].reverse();
...
const CARD_FRAME = [
  '.OOOOOOOOOOOO.',
  'OWWWWWWWWWWWWO', 'OWKKKKKKKKKKWO', 'OWKKKKKKKKKKWO', 'OWKKKKKKKKKKWO',
